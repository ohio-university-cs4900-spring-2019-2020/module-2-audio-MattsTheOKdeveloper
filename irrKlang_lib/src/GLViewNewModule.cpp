...
void GLViewNewModule::onCreate()
{
   ...
   //At this point, all the managers are initialized. That is, the engine is fully initialized.
    ...
    //Play the 2D music (background)
    ISoundSource* noise = Engine->addSoundSourceFromFile("../irrKlang/irrKlang-64bit-1.6.0/media/jazz1.mp3");
    noise->setDefaultVolume(0.1f);
    ISound* music1 = Engine->play2D(noise, true);
    //Save the 3D music to pointer
...
void GLViewNewModule::createNewModuleWayPoints()
{
   ...
   //Play the 3D music (should be at a position)
   //play3D(sound, position, loop, start_paused, track?, enable_sound_effects)
